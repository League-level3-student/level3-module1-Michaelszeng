...
public class _03_MurderOfCrows {
	ArrayList<String> stomachContents = new ArrayList<String>();
	...
	private void findTheDiamond() {
		...
		for (Crow c : theMurder) {
			deathCounter += 1;
			stomachContents = c.getStomachContents();
			if (stomachContents.contains("diamond")) {
				System.out.println(c.getName());
				finalDeaths = deathCounter;
			}
		}

		/* 2. How many innocent crows had to die before the diamond was found? */
		System.out.println("Death Count: " + finalDeaths);
	}
